...
Ce projet s’inscrit dans le cadre d’un travail universitaire portant sur la mise en place d’un site web permettant de consulter des informations sur les départements français.
...
- mettre en pratique les notions de développement web et de gestion de données
